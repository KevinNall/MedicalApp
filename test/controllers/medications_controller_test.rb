...
class MedicationsControllerTest < ActionController::TestCase
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post :create, medication: { comment: @medication.comment, dose: @medication.dose, drug_name: @medication.drug_name, time_per_day: @medication.time_per_day }
    end
  ...
  test "should update medication" do
    patch :update, id: @medication, medication: { comment: @medication.comment, dose: @medication.dose, drug_name: @medication.drug_name, time_per_day: @medication.time_per_day }
    assert_redirected_to medication_path(assigns(:medication))
  end
